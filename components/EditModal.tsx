    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-200">
        <div className="flex justify-between items-center p-4 border-b border-gray-100 bg-gray-50">
          <h3 className="font-bold text-gray-800">Edit {label || 'Content'}</h3>
          ...
          {type === 'image' && (
            <div className="space-y-4">
              ...
              <input 
                ...
                className="hidden" 
              />
              <p className="text-xs text-gray-500 text-center">Supported: JPG, PNG, WEBP (Max 5MB)</p>
            </div>
          )}
        </div>
        ...
        <div className="p-4 bg-gray-50 flex justify-end gap-3">
          ...
          <button onClick={handleSave} className="px-4 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors flex items-center gap-2 shadow-lg shadow-blue-600/20">
            <Save size={18} />
            Save Changes
          </button>
        </div>
